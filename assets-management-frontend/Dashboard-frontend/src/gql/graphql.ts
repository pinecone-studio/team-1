...
export type GetDataWipeTasksQuery = { __typename?: 'Query', dataWipeTasks: Array<{ __typename?: 'DataWipeTask', id: string, assetId: string, status: string, createdAt: number, updatedAt: number }> };
...
export type GetEmployeeAssignmentsQuery = { __typename?: 'Query', employeeAssignments: Array<{ __typename?: 'Assignment', id: string, assetId: string, employeeId: string, assignedAt: number, returnedAt?: number | null, conditionAtAssign: string, conditionAtReturn?: string | null, status: string, financing?: { __typename?: 'AssignmentFinancing', assignedValue?: number | null, paymentPlanMonths?: number | null, interestRate?: number | null, monthlyPayment?: number | null, totalPayment?: number | null } | null, asset?: { __typename?: 'Asset', id: string, assetTag: string, category: string, serialNumber: string, imageUrl?: string | null } | null, employee?: { __typename?: 'Employee', id: string, email: string, firstName: string, lastName: string } | null, requestedBy?: { __typename?: 'Employee', id: string, firstName: string, lastName: string } | null }> };
