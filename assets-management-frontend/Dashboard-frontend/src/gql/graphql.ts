...
export type AssignmentsQuery = { __typename?: 'Query', assignments: Array<{ __typename?: 'Assignment', id: string, assetId: string, employeeId: string, assignedAt: number, returnedAt?: number | null, conditionAtAssign: string, conditionAtReturn?: string | null, status: string, asset?: { __typename?: 'Asset', id: string, assetTag: string, category: string, serialNumber: string, status: string } | null, employee?: { __typename?: 'Employee', id: string, email: string, firstName: string, lastName: string } | null }> };
