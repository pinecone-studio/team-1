...
import { CreateAssetDocument } from "@/gql/graphql";
    ...
    try {
      ...
      for (let i = 0; i < parsedAssets.length; i++) {
        ...
        try {
          ...
          if (created) {
            // Very simple mapping for the UI just to show it in the list
          ...
          >
            {file ? (
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="font-medium text-gray-700">Файл энд чирж оруулах эсвэл сонгох</p>
                <p className="text-sm text-gray-500 mt-1">Зөвхөн .csv өргөтгөлтэй файл</p>
                <Button
                  variant="outline"
                  className="mt-4"
