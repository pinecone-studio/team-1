...
export const assignmentBuyoutPolicies = sqliteTable(
  "assignment_buyout_policies",
  {
    ...
    paymentPercent: numeric().notNull(), // percent of value to pay
    isFree: integer().default(0).notNull(), // 1 if free
  ...
  (table) => ({
    buyoutCategoryIdx: index("buyout_category_idx").on(table.categoryId),
  }),
);
...
export const assets = sqliteTable(
  ...
  (table) => ({
    ...
    assetsSerialNumberIdx: index("assets_serial_number_idx").on(
      table.serialNumber,
    ),
  }),
);
...
export const assignments = sqliteTable(
  ...
  (table) => ({
    ...
    assignmentsEmployeeIdx: index("assignments_employee_idx").on(
      table.employeeId,
    ),
  }),
);
...
export const assignmentFinancing = sqliteTable(
  ...
  (table) => ({
    financingAssignmentIdx: index("financing_assignment_idx").on(
      table.assignmentId,
    ),
  }),
);
...
export const assignmentPayments = sqliteTable(
  ...
  (table) => ({
    paymentFinancingIdx: index("payment_financing_idx").on(table.financingId),
...
export const transfers = sqliteTable(
  ...
  (table) => ({
    ...
    transfersFromEmployeeIdx: index("transfers_from_employee_idx").on(
      table.fromEmployeeId,
    ),
    transfersToEmployeeIdx: index("transfers_to_employee_idx").on(
      table.toEmployeeId,
    ),
  }),
);
...
export const assetMovements = sqliteTable(
  ...
  (table) => ({
    assetMovementsAssetIdx: index("asset_movements_asset_idx").on(
      table.assetId,
    ),
    assetMovementsToLocationIdx: index("asset_movements_to_location_idx").on(
      table.toLocationId,
    ),
  }),
);
...
export const maintenanceTickets = sqliteTable(
  ...
  (table) => ({
    maintenanceTicketsAssetIdx: index("maintenance_tickets_asset_idx").on(
      table.assetId,
    ),
    maintenanceTicketsStatusIdx: index("maintenance_tickets_status_idx").on(
      table.status,
    ),
  }),
);
...
export const purchaseOrders = sqliteTable(
  ...
  (table) => ({
    purchaseOrdersVendorIdx: index("purchase_orders_vendor_idx").on(
      table.vendorId,
    ),
    purchaseOrdersStatusIdx: index("purchase_orders_status_idx").on(
      table.status,
    ),
  }),
);
...
export const disposalRecords = sqliteTable(
  ...
  (table) => ({
    disposalRecordsAssetIdx: index("disposal_records_asset_idx").on(
      table.assetId,
    ),
  }),
);
...
export const disposalRequests = sqliteTable(
  ...
  (table) => ({
    disposalRequestsAssetIdx: index("disposal_requests_asset_idx").on(
      table.assetId,
    ),
    disposalRequestsStatusIdx: index("disposal_requests_status_idx").on(
      table.status,
    ),
  }),
);
...
export const offboardingEvents = sqliteTable(
  ...
  (table) => ({
    offboardingEventsEmployeeIdx: index("offboarding_events_employee_idx").on(
      table.employeeId,
    ),
    offboardingEventsStatusIdx: index("offboarding_events_status_idx").on(
      table.status,
    ),
  }),
);
...
export const notifications = sqliteTable(
  ...
  (table) => ({
    notificationsEmployeeIdx: index("notifications_employee_idx").on(
      table.employeeId,
    ),
