...
var AssetStatus = /*#__PURE__*/ function(AssetStatus) {
    ...
    AssetStatus["RepairRequested"] = "REPAIR_REQUESTED";
...
const GetDisposalRequestsDocument = {
    "kind": "Document",
    "definitions": [
        {
            "kind": "OperationDefinition",
...
const UpdateAssignmentStatusDocument = {
    "kind": "Document",
    "definitions": [
        {
            "kind": "OperationDefinition",
...
const GetDataWipeTasksDocument = {
    "kind": "Document",
    "definitions": [
        {
            "kind": "OperationDefinition",
...
const UpdateDataWipeTaskDocument = {
    "kind": "Document",
    "definitions": [
        {
            "kind": "OperationDefinition",
...
const SubmitReturnRequestDocument = {
    "kind": "Document",
    "definitions": [
        {
            "kind": "OperationDefinition",
...
const ApproveReturnRequestDocument = {
    "kind": "Document",
    "definitions": [
        {
            "kind": "OperationDefinition",
...
const documents = {
    ...
    "query GetDataWipeTasks($status: String) {\n  dataWipeTasks(status: $status) {\n    id\n    assetId\n    asset {\n      id\n      assetTag\n      category\n    }\n    latestAssignment {\n      id\n      employee {\n        id\n        firstName\n        lastName\n        department\n        branch\n      }\n    }\n    latestReturnRequest {\n      id\n      employee {\n        id\n        firstName\n        lastName\n        department\n        branch\n      }\n    }\n    status\n    createdAt\n    updatedAt\n  }\n}\n\nmutation UpdateDataWipeTask($id: ID!, $status: String!) {\n  updateDataWipeTask(id: $id, status: $status) {\n    id\n    status\n    updatedAt\n  }\n}": __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$gql$2f$graphql$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GetDataWipeTasksDocument"],
    "mutation RequestDisposal($assetId: ID!, $requestedBy: ID!, $method: String!, $reason: String) {\n  requestDisposal(\n    assetId: $assetId\n    requestedBy: $requestedBy\n    method: $method\n    reason: $reason\n  ) {\n    id\n    status\n    assetId\n  }\n}\n\nmutation ApproveDisposal($id: ID!, $approvedBy: ID!, $stage: String!) {\n  approveDisposal(id: $id, approvedBy: $approvedBy, stage: $stage) {\n    id\n    status\n  }\n}\n\nmutation RejectDisposal($id: ID!, $rejectedBy: ID!, $reason: String) {\n  rejectDisposal(id: $id, rejectedBy: $rejectedBy, reason: $reason) {\n    id\n    status\n  }\n}": __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$gql$2f$graphql$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RequestDisposalDocument"],
    ...
    "mutation CreateMaintenanceTicket($assetId: ID!, $reporterId: ID!, $description: String!, $severity: String!, $vendorId: ID, $repairCost: Int) {\n  createMaintenanceTicket(\n    assetId: $assetId\n    reporterId: $reporterId\n    description: $description\n    severity: $severity\n    vendorId: $vendorId\n    repairCost: $repairCost\n  ) {\n    id\n    assetId\n    description\n    status\n    severity\n  }\n}": __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$gql$2f$graphql$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CreateMaintenanceTicketDocument"],
    ...
    "query GetOffboardingEvent($employeeId: ID!) {\n  offboardingEvent(employeeId: $employeeId) {\n    id\n    status\n    totalAssets\n    returnedAssets\n    assetIdsJson\n    deadline\n    completedAt\n    createdAt\n    employee {\n      id\n      firstName\n      lastName\n      email\n    }\n    initiatedBy {\n      id\n      firstName\n      lastName\n    }\n    assetsToReturn {\n      id\n      assetTag\n      serialNumber\n    }\n  }\n}\n\nmutation StartOffboarding($employeeId: ID!, $initiatedBy: ID!, $terminationDate: Float) {\n  startOffboarding(\n    employeeId: $employeeId\n    initiatedBy: $initiatedBy\n    terminationDate: $terminationDate\n  ) {\n    id\n    status\n  }\n}\n\nmutation SubmitReturnRequest($assetId: ID!, $employeeId: ID!, $condition: String!, $conditionDetail: String, $photoR2Key: String) {\n  submitReturnRequest(\n    assetId: $assetId\n    employeeId: $employeeId\n    condition: $condition\n    conditionDetail: $conditionDetail\n    photoR2Key: $photoR2Key\n  ) {\n    id\n    assetId\n    status\n    conditionEmployee\n  }\n}\n\nmutation CompleteAssetReturn($assetId: ID!, $employeeId: ID!, $condition: String!, $inspectedBy: ID!) {\n  completeAssetReturn(\n    assetId: $assetId\n    employeeId: $employeeId\n    condition: $condition\n    inspectedBy: $inspectedBy\n  ) {\n    id\n    assetTag\n    status\n  }\n}\n\nmutation ApproveReturnRequest($returnRequestId: ID!, $conditionHr: String!, $inspectedBy: ID!) {\n  approveReturnRequest(\n    returnRequestId: $returnRequestId\n    conditionHr: $conditionHr\n    inspectedBy: $inspectedBy\n  ) {\n    id\n    assetTag\n    status\n  }\n}\n\nmutation RequestRepair($returnRequestId: ID!, $conditionHr: String!, $photoR2Key: String, $inspectedBy: ID!) {\n  requestRepair(\n    returnRequestId: $returnRequestId\n    conditionHr: $conditionHr\n    photoR2Key: $photoR2Key\n    inspectedBy: $inspectedBy\n  ) {\n    id\n    assetTag\n    status\n  }\n}": __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$gql$2f$graphql$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GetOffboardingEventDocument"],
    ...
    "query GetVendors {\n  vendors {\n    ...VendorFields\n  }\n}\n\nquery GetCategories {\n  categories {\n    ...CategoryFields\n    subcategories {\n      ...CategoryFields\n    }\n  }\n}\n\nquery GetLocations {\n  locations {\n    ...LocationFields\n  }\n}": __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$gql$2f$graphql$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GetVendorsDocument"]
};
